...
export const getExternalDetails = async (inputData) => {
  //return axios.post('http://13.59.144.105:9003/Question_answering', inputData)
  return axios.get('assets/nih.json')
    .then(response => {
      // Return data from the API call
      return response.data;
    })
...
export const getDashboardCount = async (id) => {
  //return axios.get(`http://13.59.144.105:9004/dash_board_data/?study_id=${id}`)
  return axios.get('assets/dashCount.json')
    .then(response => {
      // Return data from the API call
      return response.data;
    })
